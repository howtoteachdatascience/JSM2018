...
To learn more about RStudio, follow this tutorial: 

* [RStudio](https://rafalab.github.io/dsbook/getting-started.html#installing-rstudio)
...
To learn more about unix tools and RStudio, follow these tutorials: 
...
Next, let's look at these two tutorials:
...
## Set up Slack for course communication
