...
knitr::opts_chunk$set(echo=FALSE,  out.width = "800px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"')
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-layout.png") 
```
...
```{r, include=FALSE}
require("knitr")
old_root_dir <- opts_knit$get("root.dir")
opts_knit$set(root.dir = "git-example/murders")
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-clone.png") 
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-status.png") 
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-add.png") 
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-commit.png") 
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-push.png") 
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-fetch.png") 
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-merge.png") 
```
...
```{r, echo=FALSE,  out.width = "700px", out.extra='style="display: block; margin-left: auto; margin-right: auto; background-color: #000; padding:3px;"'}
knitr::include_graphics("img/git/git-pull.png") 
```
...
We called it _murders_ to match the name of the directory on our local system. But if you are doing this for another project please chose an appropriate name.
...
if(file.exists("git-example")) unlink("git-example", recursive=TRUE, force = TRUE)
setwd(original_dir)
opts_knit$set(root.dir = old_root_dir)
```
